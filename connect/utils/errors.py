"""Error codes and response helpers for the connect app."""
...
HTTP_STATUS = {
    ...
    ERROR_CODES["SERIALIZATION_ERROR"]: 500,
    ERROR_CODES["SCHEMA_ERROR"]: 500,
    ERROR_CODES["KAFKA_ERROR"]: 502,
    ERROR_CODES["IDEMPOTENCY_ERROR"]: 409,
    ERROR_CODES["CONSUMER_ERROR"]: 500,
