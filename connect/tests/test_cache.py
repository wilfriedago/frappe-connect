...
class TestCacheHelpers(unittest.TestCase):
	...
	def test_cache_set(self, mock_frappe):
		...
		mock_cache.set_value.assert_called_once_with("my_key", "my_value", expires_in_sec=300)
	...
	def test_cache_get_or_set_miss(self, mock_frappe):
		...
		mock_cache.set_value.assert_called_once_with("key", "computed", expires_in_sec=120)
